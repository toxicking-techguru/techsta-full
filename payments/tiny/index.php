...
if(isset($_POST['submit'])){
    ...
    $headers = array(
        ...
        'ApiKey: 63e4fd860401e' // Replace with your api key
     );
...
<body oncontextmenu='return false' class='snippet-body'>
    <div class="container mt-5 d-flex justify-content-center">
        ...
        <div class="card p-3">
            ...
            <div class="px-5"> <span class="button mt-3 d-block bg-white p-2">pay KSH 750.00 to techsta</span> </div>
            <br>
