...
if (!defined('APP_NAME'))                       define('APP_NAME', 'Techsta');
...
if (!defined('MAIL_USERNAME'))                  define('MAIL_USERNAME', 'superset@superset.com');
if (!defined('MAIL_PASSWORD'))                  define('MAIL_PASSWORD', 'superset');
